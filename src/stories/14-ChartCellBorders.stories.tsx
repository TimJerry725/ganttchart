...
const links: Link[] = [
  ...
  { id: 'l5', source: '3.1', target: '3.2', type: 'e2s' },
];
 ...
 */
export const VerticalBordersOnly: Story = {
  args: {
    tasks,
    links,
    showVerticalBorders: true,
 ...
 */
export const HorizontalBordersOnly: Story = {
  args: {
    tasks,
    links,
 ...
 */
export const DashedBorders: Story = {
  args: {
    tasks,
    links,
    showVerticalBorders: true,
 ...
 */
export const DottedBorders: Story = {
  args: {
    tasks,
    links,
    showVerticalBorders: true,
 ...
 */
export const CustomColorBorders: Story = {
  args: {
    tasks,
    links,
    showVerticalBorders: true,
